...
```{r}
plot(mt_nj_rooted, main = "Árbol NJ enraizado usando Gorila como Outgroup")
```
...
plot(mt_nj_rtt, align.tip.label = TRUE, main = "Árbol NJ enraizado por Regresión Root-to-Tip (RTT)")
add.scale.bar()
```
